...
| `arisc-fw-addrs.py` | löst die SRAM-Adressen eines `h713-arisc.bin` auf - dasselbe Verfahren wie der Treiber (Kernel-Patch 0091a), zum Prüfen eines fremden Abzugs |
