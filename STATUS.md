...
|---|---|---|---|
| **HY310** (silkscreen `HY260_QZ713_V3.1`) | **verified** | the owner (well0nez), on his HY310, `v0.9-beta`, 22.09.2026; the development builds `v0.8-dev20` to `v0.8-dev22` on 22.09.2026, and the keystone slots of 22. to 24.09.2026 (GPU, warp, accelerometer) on a `v0.9-beta` image with the branch on top | everything else on this page. The only board a *release* image is built for; `hy300-pro` gets TEST images only |
