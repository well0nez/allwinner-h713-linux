...
- ☑ P2.3 TF-A: unser Gate-Commit `3b3fb35fa` auf Zweig `sun50i-h713` (war losgelöst).
- ☑ P2.4 **Private** Repos `well0nez/sunxi-tools` (h713 = 269dfa2, master) und `well0nez/arm-trusted-firmware` (sun50i-h713 = 3b3fb35fa, master) angelegt und gepusht; Standardzweige gesetzt. Inhalt vorher auf IPs/Schlüssel/Pfade geprüft: nichts. Push mit `-c credential.helper='!gh auth git-credential'` — keine globale Git-Konfiguration angefasst.
