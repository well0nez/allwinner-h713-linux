...
/* Returns whether FDRV_NO_REG_SDIO is configured.
 * This function is referenced by aicwf_sdio.c as extern.
 * CONFIG_FDRV_NO_REG_SDIO is set to n in our Makefile.
 */
