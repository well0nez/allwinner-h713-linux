"""HY300 Pro+ (2025, LPDDR3) -- board profile. Data only, no vendor bytes: numbers, hashes, strings.

The board this stock image belongs to is cstenger's `HY200 QZ713_V2`: its boot0 DRAM block is his
`configs/hy200_qz713_v2_defconfig` word for word (720 MHz, type 7, zq 0x3f3ffb, odt_en 0x31,
para1 0x10f410f4, tpr7 0x1621121e, tpr10 0x7767, tpr11/12 0x44650000/0x5544). Only para2/tpr13 differ
(the flashing tool patches that pair) and tpr0..tpr2, which he read off the running board -- and on
this board, the only one on the LPDDR3 path, tpr0..tpr2 do reach the hardware.
...
PROFILE = {
    "id": "hy200_qz713_v2",
    "name": "HY300 Pro+ (2025, LPDDR3) -- HY200 QZ713_V2",
    "description": "HY300 Pro+ -- Allwinner H713, reference design h713_tuna_p3, LPDDR3 720 MHz, "
                   "stock build 2025-07-10 (projector07101345)",   # J vendor_build_prop, J boot0.dram
    ...
    "stock": {
        ...
        "uboot_version": "U-Boot 2018.05-00026-gdfcfa80-dirty (Jul 10 2025 - 13:42:59 +0800)",
        "arisc_version": "TV-303  ARISC  00.00.00.09 Date:Jul 10 2025",
        "package_items": {                   # J boot_package.items
            "u-boot":  ( 638976, "ce38189b8c1532ef3ba7656688fb8f352bedd03456dc0abeac109fa43ab657ce"),
            "monitor": (  66060, "95596d11aa6d10c0f3c8ef2c0d6fa01446be320c412decc201a5b547d6475ed7"),
            "scp":     ( 176132, "9ad60f9f9ab6ba1ad06fabdfbb4e300bd838d12414ddffde722e50f178e95824"),
            "optee":   ( 275328, "9b3addd56be7b1fe8d5fbcaafed191239ed77bde5190f91e6725b7ffa8916b61"),
            "dtb":     (  73728, "ad84cb3f4350926f2193852f6d2eb6cc57618eb4c3807ba789265fbf6aa527a7"),
        },
        "vendor_size": 114417664,            # J super.partitions vendor_a
        # Every feature that tells this image apart from its DDR3 sibling (0922) and from every other
        # profile. Left out on purpose: mips_database_sha256 -- both HY300 Pro+ images carry the same
        # mips/database.TSE (27e2abad...), so it separates nothing here (the reason the ADT-3 profiles
        # leave it out too, doku/121 section 2, finding 1); and vendor_size.
    ...
    "dram": {                                # J boot0.dram -- the 24 u32 at boot0_sdcard.fex+0x38
        "clk": 720, "type": 7, "zq": 0x3f3ffb, "odt_en": 0x31,
        "para1": 0x10f410f4, "para2": 0x1000,
        "mr0": 0, "mr1": 0xc3, "mr2": 0xa, "mr3": 2,
        "tpr0": 0x4a2195, "tpr1": 0x2423190, "tpr2": 0x8b061, "tpr3": 0xb4787896,
        "tpr4": 0, "tpr5": 0x48484848, "tpr6": 0x48, "tpr7": 0x1621121e,
        "tpr8": 0, "tpr9": 0, "tpr10": 0x7767, "tpr11": 0x44650000,
        "tpr12": 0x5544, "tpr13": 0x34032220,
        ...
        # 0xb4036223, cstenger's values). boards/README.md, "Two conventions".
        "source": "boot0_sdcard.fex offset 0x38, "
                  "hy300-pro-downloads/gdrive/HY300pro+ 0710/update.img (sha256 342806d8..., J input)",
    },
    "layout": {                              # J sys_partition[] -- the stock table of this image
        ...
        # name, start LBA, sectors, downloadfile -- rows of J sys_partition in table order. Identical
        # to the DDR3 image's table, and the same shape as the HY310's: 26 entries, Reserve0_a/_b.
        "partitions": [
    ...
    "mips": {
        ...
        "revisions": [                       # F, row "HY200 QZ713_V2"; size/sha256 = J mips_files
            # hdcp_wait_va computed with h713.hdcpsite.search() over the extracted display.bin
            # (fixtures-local/vendor-boot/hy300-pro-plus-lpddr3/boot/mips/display.bin): one hit with
            # context at offset 0x3d538 -> 0x4b13d538 (base 0x4b100000). h713_mips_fw_revs[] declares
            # no row for this revision: its size 0x1328f0 is in no row of that table.
            {"size": 1255664, "sha256": "4628cbaf8c93ea12ec59e871e4250facf0773daae722b251c73f1fad81e80c2c",
             "name": "HY200 QZ713_V2", "hdcp_wait_va": 0x4b13d538},
        ],
    },
    ...
    # B board.env KERNEL_DTB: cstenger's device tree for this board, built but marked untested on
    # hardware in his tree too (mainline/config/versions.env).
    "board_dt": "sun50i-h713-hy200-qz713-v2",
    "uboot_board": "hy200-qz713-v2",         # B board.env UBOOT_BOARD (base hy200_qz713_v2_defconfig)
}
