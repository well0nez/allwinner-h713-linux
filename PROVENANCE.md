...
`mainline/patches/kernel/series` carries 138 patches in fourteen sections:
...
| well0nez, follow-ups | `0005a`, `0013a`, `0014a`, `0024a` - `0024c`, `0078a`, `0136a`, `0136c` | small fixes placed directly after the original they touch, so the original stays byte-identical. `0013a` carries three decd corrections from cstenger's branch; `0005a` (USB PHY SIDDQ), `0136a` and `0136c` (HDMI hot plug) are ours, 15./16.09. |
