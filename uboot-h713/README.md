...
`release/repo-skelett.sh` ruft `git format-patch 8fe568cdfc4..4091ea68c06` im
Submodul-Checkout `mainline/external/u-boot` (Zweig `h713-hy310`, Basis ist
cstengers `h713`). `SERIES.txt` nennt Basis, Kopf und Anzahl. Wer etwas ändern
