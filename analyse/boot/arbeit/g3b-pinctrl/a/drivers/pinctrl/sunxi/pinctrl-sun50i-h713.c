...
static const struct sunxi_desc_pin h713_pins[] = {
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(D, 23),
		  ...
		  SUNXI_FUNCTION_IRQ_BANK(0x6, 3, 23)),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(D, 24),
		  SUNXI_FUNCTION(0x0, "gpio_in"),
		  SUNXI_FUNCTION(0x1, "gpio_out"),
		  SUNXI_FUNCTION(0x3, "i2s2"),
		  SUNXI_FUNCTION_IRQ_BANK(0x6, 3, 24)),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(D, 25),
		  SUNXI_FUNCTION(0x0, "gpio_in"),
		  SUNXI_FUNCTION(0x1, "gpio_out"),
		  SUNXI_FUNCTION(0x3, "i2s2"),
		  SUNXI_FUNCTION_IRQ_BANK(0x6, 3, 25)),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(D, 26),
		  SUNXI_FUNCTION(0x0, "gpio_in"),
		  SUNXI_FUNCTION(0x1, "gpio_out"),
		  SUNXI_FUNCTION(0x3, "i2s2"),
		  SUNXI_FUNCTION_IRQ_BANK(0x6, 3, 26)),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(D, 27),
		  SUNXI_FUNCTION(0x0, "gpio_in"),
		  SUNXI_FUNCTION(0x1, "gpio_out"),
		  SUNXI_FUNCTION(0x3, "i2s2"),
		  SUNXI_FUNCTION_IRQ_BANK(0x6, 3, 27)),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(D, 28),
		  SUNXI_FUNCTION(0x0, "gpio_in"),
		  SUNXI_FUNCTION(0x1, "gpio_out"),
		  SUNXI_FUNCTION(0x3, "i2s2"),
		  SUNXI_FUNCTION_IRQ_BANK(0x6, 3, 28)),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(D, 29),
		  SUNXI_FUNCTION(0x0, "gpio_in"),
		  SUNXI_FUNCTION(0x1, "gpio_out"),
		  SUNXI_FUNCTION(0x3, "i2s2"),
		  SUNXI_FUNCTION_IRQ_BANK(0x6, 3, 29)),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(D, 30),
		  SUNXI_FUNCTION(0x0, "gpio_in"),
		  SUNXI_FUNCTION(0x1, "gpio_out"),
		  SUNXI_FUNCTION_IRQ_BANK(0x6, 3, 30)),
